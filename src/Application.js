...
export default class Application {
    constructor() {
        ...
        this._mainAssets = [
            //single sprite
            {name: 'bunny', uri: './assets/' + 'textures' + '/' + 'bunny' + '.png'},
            //texture packer json texture sheet
            {name: 'buttons', uri: './assets/' + 'textures' + '/' + 'buttons' + '.json'},
            {name: 'game_objs', uri: './assets/' + 'textures' + '/' + 'game_objs' + '.json'},
            //dragon bones
            {name: 'char_ske', uri: './assets/' + 'textures' + '/' + 'char_ske' + '.json'},
            {name: 'char_tex', uri: './assets/' + 'textures' + '/' + 'char_tex' + '.png'},
            {name: 'char_texData', uri: './assets/' + 'textures' + '/' + 'char_tex' + '.json'},
            //"old school" style texture sheet
            //{name: 'alien', uri: './assets/' + 'textures' + '/' + 'alien' + '.png'}
            //  {name: 'tile_sheet_1', uri: './assets/' + 'textures' + '/' + 'tile_sheet_1' + '.png'},
            //  {name: 'tiles', uri: './assets/' + 'textures' + '/' + 'tiles' + '.png'},
            {name: 'tileset', uri: './assets/' + 'textures' + '/' + 'tileset' + '.png'}
        ];
         ...
         */
        this._dataFiles = [
            {name: 'test_level', uri: './assets/' + 'data' + '/' + 'test_level' + '.json'}
        ];
